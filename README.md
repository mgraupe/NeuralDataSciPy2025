...
All lectures and guided tutorials take place at **9h-11h on Fridays's in room GRIGNARD F, 4th floor, 45 rue des Saints-Pères** between **September 12th and Dec 5th, 2025**.
...
|----|------------|----------------------------------------------------------------------------------------|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| 
| 1  | Fri Sep 12 | Introduction to Python : first steps                                                   | Michael Graupner     | Lecture, Tutorial, Homework, Deepnote Link                                                                                                                                                                                                                                                                                                                                    |
| 2  | Fri Sep 19 | Time series : basic operations                                                         | Michael Graupner     | [ Lecture, Tutorial, Homework, Deepnote Link                                                                                                                                                                                                                                                                                                                                  |
| 3  | Fri Sep 26 | Wrangling Data : loading, understanding and visualizing                                | Tadeusz Kononowicz     | Lecture, Tutorial, Homework, Deepnote Link                                                                                                                                                                                                                                                                                                                                    | 
| 4  | Fri Oct 3  | Wrangling spike trains : basic analysis, raster plot, PSTH, Poisson spike trains       | Tadeusz Kononowicz     | Lecture, Tutorial, Homework, Deepnote Link                                                                                                                                                                                                                                                                                                                                    | 
| 5  | Fri Oct 10 | Regression analysis : correlation analysis, logisitic regression, nonlinear regression | Tadeusz Kononowicz      | Lecture, Tutorial, Homework, Deepnote Link                                                                                                                                                                                                                                                                                                                                    |  
...
| 10 | Mon Nov 17 | Classification and clustering : SVM, KMeans estimate                                   | Heike Stein | Lecture, Tutorial, Homework, Deepnote Link                                                                                                                                                                                                                                                                                                                                    |
...
| <img src="miscFiles/tadeusz.jpg" width="100px" />                   | Tadeusz Kononowicz | [tadeusz.kononowicz@cnrs.fr](mailto:tadeusz.kononowicz@cnrs.fr)                  | NeuroPSI,
 CNRS Université Paris-Saclay, 151 route de la Rotonde, 91400 Saclay |
